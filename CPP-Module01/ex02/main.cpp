...
// Una referencia es una variable que se refiere o "apunta" a otra variable en la memoria,
// es decir, es una especie de "alias" para esa variable. Al igual que una variable normal,
// una referencia tiene un nombre y un tipo de datos, pero a diferencia de una variable normal,
// una referencia no tiene una dirección de memoria propia. En su lugar, se refiere a la
// dirección de memoria de la variable original. Por lo tanto, cualquier cambio
// que se haga en la referencia se reflejará en la variable original.
